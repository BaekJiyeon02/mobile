    ...
    case 'DO':
      return (
        <View style={styles.conatiner}>
          {/* O 지성 */}
          {/* <View style={{ width: width * 160, height: height *  23, backgroundColor: "#FFD4AC", top: 9, right: 30, position: 'absolute' }}></View> */}
          <View style={{ width: width * 160, height: height *  23, backgroundColor: "#FFD4AC", top: 9, right: 30, position: 'absolute' }}></View>
          {/* D 건성 */}
          <View style={{ width: width * score, height: height *  23, backgroundColor: "#FF5959", top: 9, left: 30, position: 'absolute' }}></View>
